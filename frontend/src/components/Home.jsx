...
function Home ()  {
  ...
  return (
    <div className='bg-gradient-to-r from-black to-blue-950 h-fit '>
      ...
      <section className='text-center py-2'>
        <h1 className='text-4xl font font-semibold text-orange-500'>CourseHeaven</h1>
        <br />
        ...
        <div className='space-x-4'>
          ...
          <Link to={"https://www.youtube.com/c/LearnCodingOfficial"} className='bg-white text-black py-3 px-6 rounded font-semibold hover:bg-green-500 duration-300 hover:text-white' >
            Courses Videos
      ...
      <Slider {...settings}>
        {
         ...
         courses.map((course)=>(
          <div key={course._id} className='p-4'>
            <div className='relative flex-shrink-0 w-53 transition duration-300 transform hover:scale-105'>
      ...
      <footer className='my-8 p-5'>
        <div className='grid grid-cols-1 md:grid-cols-3'>
         ...
         <div className='flex items-center space-x-2'>
          ...
          <div className='items-center flex flex-col'>
            <h3 className='text-lg font-semibold mb-4'>copyrights &copy; 2025</h3>
            <ul className='space-y-2 text-gray-400'>
              <li className='hover:text-white cursor-pointer duration-300'>
                Terms & Conditions
                </li>
