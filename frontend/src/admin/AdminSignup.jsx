...
function AdminSignup() {
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="pb-3 container mx-auto flex  items-center justify-center text-white">
        {/* Header */}
        ...
        {/* AdminSignup Form */}
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg w-[500px] mt-20">
          <h2 className="text-2xl font-bold mb-4 text-center">
            Welcome to <span className="text-orange-500"> Admin Signup</span>
          </h2>
          <p className="text-center text-gray-400 mb-6">
            Just <strong>Admin</strong> signup to mess with dashboard!
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Link
              to={"/signup"}
              className="block w-full mt-2.5 bg-blue-500 hover:bg-blue-200 text-black py-3 px-6 rounded-md transition text-center"
            >
              User Signup
            </Link>
          </form>
